...
class Database(object):
    ...
    FIELD_NUM_FRAMES = 'num_frames'
    FIELD_LOG_ENTRY_ID = 'entry_id'
    FIELD_TIMESTAMP = 'entry_ts'
    FIELD_REGION = 'region'
    FIELD_SOURCE_ID = 'source_id'
    FIELD_PROGRAM_NAME = 'program_name'
    FIELD_PROGRAM_ID = "program_id"
    FIELD_SCHEDULE_ID = "schedule_id"
    ...
    def insert_identification_log(self, song_id, song_name, offset, program_name, external_id, region, source_id, program_id, schedule_id):
        """
        Inserts a identification record into the log table, returns the new
    ...
    @abc.abstractmethod
    def insert_song(self, song_name, num_frames):
        """
        Inserts a song name into the database, returns the new
        identifier of the song.

        song_name: The name of the song.
	num_frames: Number of frames of the song
        """
        pass
